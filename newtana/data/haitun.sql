...
(2, 'web_site_title', '站点标题', 'base', 'text', '先舟科技', '', '调用方式：<code>config(\'web_site_title\')</code>', '', '', '', '', '', 2, '', '', '', '', 1475240646, 1477710341, 2, 1),
(3, 'web_site_slogan', '站点标语', 'base', 'text', '先舟科技', '', '站点口号，调用方式：<code>config(\'web_site_slogan\')</code>', '', '', '', '', '', 2, '', '', '', '', 1475240994, 1477710357, 3, 1),
...
(6, 'web_site_keywords', '站点关键词', 'base', 'text', '先舟科技', '', '网站搜索引擎关键字', '', '', '', '', '', 2, '', '', '', '', 1475241328, 1475241328, 7, 1),
...
INSERT INTO `admin_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(1, 31, 1, 2886926337, 'admin_menu', 68, '超级管理员 编辑了节点：节点ID(68)', 1, 1553563783),
(2, 31, 1, 2886926337, 'admin_menu', 68, '超级管理员 编辑了节点：节点ID(68)', 1, 1553563876),
(3, 31, 1, 2886926337, 'admin_menu', 19, '超级管理员 编辑了节点：节点ID(19)', 1, 1553563906),
(4, 31, 1, 2886926337, 'admin_menu', 214, '超级管理员 编辑了节点：节点ID(214)', 1, 1553563920),
(5, 32, 1, 2886926337, 'admin_menu', 68, '超级管理员 删除了节点：节点ID(68),节点标题(管理员),节点链接(user/index/index)', 1, 1553563925),
(6, 31, 1, 2886926337, 'admin_menu', 20, '超级管理员 编辑了节点：节点ID(20)', 1, 1553563964);
...
(2, 1, 'admin', '快捷操作', 'fa fa-fw fa-folder-open-o', 'module_admin', '', '_self', 0, 1467618170, 1553563800, 1, 1, 1, ''),
...
(5, 4, 'admin', '系统功能', 'si si-wrench', 'module_admin', '', '_self', 0, 1467618441, 1553563800, 2, 1, 1, ''),
...
(19, 4, 'admin', '管理员', 'fa fa-fw fa-key', 'module_admin', '', '_self', 0, 1467688065, 1553563906, 1, 1, 1, ''),
(20, 19, 'admin', '管理员管理', 'fa fa-fw fa-user', 'module_admin', 'user/index/index', '_self', 0, 1467688137, 1553563964, 1, 1, 1, ''),
...
(32, 4, 'admin', '扩展中心', 'si si-social-dropbox', 'module_admin', '', '_self', 0, 1467688853, 1553563800, 3, 1, 1, ''),
...
(214, 1, 'admin', '消息管理', 'fa fa-fw fa-comments-o', 'module_admin', '', '_self', 0, 1520492129, 1553563920, 100, 0, 1, ''),
(215, 214, 'admin', '消息列表', 'fa fa-fw fa-th-list', 'module_admin', 'user/message/index', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(216, 215, 'admin', '新增', '', 'module_admin', 'user/message/add', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(217, 215, 'admin', '编辑', '', 'module_admin', 'user/message/edit', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(218, 215, 'admin', '删除', '', 'module_admin', 'user/message/delete', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(219, 215, 'admin', '启用', '', 'module_admin', 'user/message/enable', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(220, 215, 'admin', '禁用', '', 'module_admin', 'user/message/disable', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
(221, 215, 'admin', '快速编辑', '', 'module_admin', 'user/message/quickedit', '_self', 0, 1520492195, 1520492195, 100, 0, 1, ''),
...
(1, 'SystemInfo', '系统环境信息', 'fa fa-fw fa-info-circle', '在后台首页显示服务器信息', '蔡伟明', 'http://www.caiweiming.com', '{\"__token__\":\"53e059569b2dfeb46ff2f202ec345f02\",\"display\":\"1\",\"width\":\"12\"}', '1.0.0', 'system_info.ming.plugin', 0, 1477757503, 1477757503, 100, 1);
...
(1, 'admin', '超级管理员', '$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK', '', 0, '', 0, 0, '0.00', 0, 1, 0, 0, 1476065410, 1553564188, 1553564188, 2886926337, 100, 1);
...
--
-- 使用表AUTO_INCREMENT `admin_action`
--
ALTER TABLE `admin_action`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- 使用表AUTO_INCREMENT `admin_attachment`
--
ALTER TABLE `admin_attachment`
...
--
-- 使用表AUTO_INCREMENT `admin_hook`
--
ALTER TABLE `admin_hook`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- 使用表AUTO_INCREMENT `admin_hook_plugin`
--
ALTER TABLE `admin_hook_plugin`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用表AUTO_INCREMENT `admin_icon`
--
ALTER TABLE `admin_icon`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `admin_icon_list`
--
ALTER TABLE `admin_icon_list`
...
--
-- 使用表AUTO_INCREMENT `admin_message`
--
ALTER TABLE `admin_message`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `admin_module`
--
ALTER TABLE `admin_module`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用表AUTO_INCREMENT `admin_packet`
--
ALTER TABLE `admin_packet`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `admin_plugin`
--
ALTER TABLE `admin_plugin`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
